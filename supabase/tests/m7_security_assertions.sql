...
-- base-table access. Every check raises an exception (aborting the run) if the
-- guarantee is missing, so a clean run == all guarantees present.
--
-- Run against a migrated database:
--     supabase db reset            # applies 0001..0391
