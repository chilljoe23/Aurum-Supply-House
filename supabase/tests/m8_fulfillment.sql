...
\echo '== 1 · Baseline derived states (nothing shipped) =='
do $$
begin
...
\echo '== 2 · Independent operational statuses per line =='
...
\echo '== 3 · Zero and negative shipped quantities are rejected =='
...
\echo '== 4 · Over-ship is rejected (atomic: partial rollback leaves nothing) =='
do $$ declare ok boolean := false; begin
  begin
...
\echo '== 5 · Partial shipment of line A (4 of 10) on date d1 =='
...
\echo '== 6 · Financial snapshot is UNCHANGED by shipping =='
do $$
begin
...
\echo '== 7 · Issued invoice remains financially immutable (direct edit blocked) =='
do $$ declare ok boolean := false; begin
...
\echo '== 8 · Second shipment completes line A (6 more) on a different date =='
...
\echo '== 9 · Cannot ship beyond remaining on line A (now fully shipped) =='
do $$ declare ok boolean := false; begin
  begin
    perform public.create_shipment('00000000-0000-0000-0000-0000000000e1', current_date, 'FedEx', null, null, null, null,
...
\echo '== 10 · Ship line B fully (5 of 5) → order fully_shipped =='
...
\echo '== 11 · Append-only: finalized shipments cannot be edited or deleted =='
...
\echo '== 12 · Audited void restores the remaining balance =='
do $$ declare v uuid;
begin
...
\echo '== 13 · Cancelled-line handling =='
...
\echo '== 14 · Audit trail recorded for create + status change =='
do $$
begin
...
-- ===========================================================================
\echo '== 15 · Admin may create shipments; Sales Rep may not =='
...
\echo '== 16 · Rep row-scoped read isolation (RLS on, authenticated role) =='
...
\echo '== 17 · Packing-slip read surface carries NO pricing/cost columns =='
do $$ declare bad text;
begin
